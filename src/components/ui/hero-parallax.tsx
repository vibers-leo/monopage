...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white font-serif leading-tight">
        Created with <br /> ArtPage
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 font-light text-muted-foreground">
        수많은 아티스트들이 ArtPage를 통해 자신만의 디지털 갤러리를 구축했습니다. <br/>
        당신의 영감을 현실로 만드세요.
      </p>
    </div>
  );
